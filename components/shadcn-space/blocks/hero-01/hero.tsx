          ...
          <div className="container mx-auto relative z-10">
            <div className="flex flex-col max-w-5xl mx-auto gap-8">
              <div className="relative flex flex-col text-center items-center sm:gap-6 gap-4">
                ...
                >
                  Your ultimate one-stop shop for all point of sale and website solutions.
From enhancing your checkout experience to optimizing online sales,
we've got you covered. Let's elevate your business together.
                </motion.p>
              </div>
              <motion.div
                initial={{ opacity: 0, y: 32 }}
