          ...
          <div className="flex flex-col gap-8 md:gap-16">
            ...
            >
              ...
              <h1 className="text-3xl md:text-4xl font-semibold text-center tracking-[-1px]">
                Let’s get Started with a way of Ease
              </h1>
              <motion.p
                  initial={{ opacity: 0, y: 32 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 1, delay: 0.1, ease: "easeInOut" }}
                  className="text-base font-normal max-w-2xl text-muted-foreground text-center"
                >
                 Our POS system empowers your business to adapt, attract new customers, boost profits, and future-proof operations.
                </motion.p>
            </motion.div>
            <motion.div
              variants={{
